...
if __name__ == '__main__':
    ...
    argparser.add_argument('-a', '--audio_dir')
    argparser.add_argument('-o', '--out_dir')    
    argparser.add_argument('-f', '--fs', default=16000)
    argparser.add_argument('-t', '--time', default=5)  
    
    args = argparser.parse_args()            
    #pdb.set_trace() 
    mp3_to_wav(args.audio_dir, args.audio_dir)
    split_audio(args.audio_dir, args.out_dir, args.fs, args.time)
